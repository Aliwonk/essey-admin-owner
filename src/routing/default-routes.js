...
const RegisterCompany = lazy(() => import('views/default/RegisterCompany'));
const ResetPassword = lazy(() => import('views/default/ResetPassword'));
const Unauthorized = lazy(() => import('views/default/Unauthorized'));
const ConfirmEmail = lazy(() => import('views/default/ConfirmEmail'));
...
const defaultRoutes = [
  ...
  { path: DEFAULT_PATHS.REGISTER_COMPANY, exact: true, component: RegisterCompany },
  ...
  { path: DEFAULT_PATHS.EMAIL_CONFIRM, exact: true, component: ConfirmEmail },
